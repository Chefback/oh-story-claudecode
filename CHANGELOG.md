...
- 新增 **material-decomposition.md** 短篇拆解方法论：节拍提取、情绪炸弹分析、技法分析框架（POV/对话/时间/信息/意象）、节奏密度四维指标、角色经济性评估、结构模式匹配
...
- 新增节拍提取：密度公式（200-300字/个，15-60个全文）、6种节拍类型、情绪标记（-9~+9）
- 新增情绪架构：情绪炸弹6组件分析（引信/火药/延时/引爆/弹片/弹坑）、期待管理追踪
- 新增技法分析：POV策略（含切换检测）、对话量化（占比/潜台词率/模式识别）、信息控制矩阵、意象追踪
- 新增角色功能标签（6种）、内在矛盾提取、弧线记录、经济性评估、关系演变追踪
- 新增可选模块：同类对比、平台适配评估（知乎/番茄/七猫）、节奏密度热力图
- 新增质量门控：节拍覆盖率≥90%、情绪曲线100%、技法≥5项、角色100%
- 精细/标准双模式路由
