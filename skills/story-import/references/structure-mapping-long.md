...
- **输出对齐**：严格对齐 `../../story-long-write/references/artifact-protocols.md:237-252` 的标准模板，全文加 `[导入反推]` 标记；
...
- [ ] 追踪/角色状态.md 已生成且对齐 `../../story-long-write/references/artifact-protocols.md` 标准模板
- [ ] 追踪/上下文.md 进度摘要已填写
- [ ] 散落情节已合并到相关卷纲或大纲附录
- [ ] 所有 `[导入反推]` 标记已添加
