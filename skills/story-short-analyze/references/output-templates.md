...
曲线特征：起始{...} | 走向{上行/下行/波浪/V形/倒V/阶梯/断崖/压缩弹簧/甜度阶梯/心酸双峰} | 极值{最高%X 最低%Y} | 方向差{从X到Y} | 翻转次数{N}
...
**隐性反转（回看反转）**：如有开头语句在真相揭示后含义完全改变，标注：
- 回看语句原文 + 位置
- 初读理解 vs 回看理解
- 触发认知升级的事件
...
| 潜台词率 | {X%} | {高手>60%/中等/偏低} |
| 对话模式 | {审判式/压制式/信息差式/推拉式/称呼操控式} | {具体说明} |
...
**意象系统**：如多个物件服务同一主题，标注系统主题、各物件的映射角度、系统整体效果。
...
| 价值观传达 | {这篇故事最终想说什么？} |
| 结尾情绪强度 | {1-10，参考标准：虐≥8/爽≥7/治愈≥6/通透满足≥5/震惊反转≥7/BE意难平≥8} |
...
**二次阅读设计**：如有开头语句在真相揭示后含义完全改变，列出：语句原文 + 位置 + 初读理解 vs 回看理解。
