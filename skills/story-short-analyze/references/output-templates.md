...
| 人物 | 分类 | 功能标签 | 内在矛盾 | 一句话画像 | 弧线 | 关键台词 |
|------|------|----------|----------|-----------|------|----------|
| {主角名} | {主人公/主动人物/被动人物} | {情绪承载者/...} | {核心心理冲突} | {从行为归纳} | {始→转→终} | "{最具代表性的台词}" |
| {配角名} | {主动人物/被动人物/功能人物} | {压迫源/...} | {矛盾} | {画像} | {弧线/扁平} | "{台词}" |
...
**Phase 2（结构+情节节点）**：
- [ ] 故事核已提取（一句话核心梗）
- [ ] 结构划分至少 4 段（开端/发展/高潮/结局），每段有字数范围、占比和功能
- [ ] 结局类型已标注
- [ ] POV 已识别
- [ ] 叙事时间线已标注
...
**Phase 5（人物+开头结尾）**：
- [ ] 所有有名人物已提取，有人物分类（主人公/主动人物/被动人物/功能人物）
- [ ] 人物功能评估已完成
- [ ] 人物关系已标注演变轨迹
- [ ] 前 3 句话原文引用
- [ ] 前50字/前100字检查已完成
